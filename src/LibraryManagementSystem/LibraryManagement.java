...
class LibraryManagement {
    ...
    public void admin_mainpage() {
        System.out.println("--------------------------------------------------------");
        System.out.println("-----  Library ---> Welcome Admin " + LibraryManagement.userID + "! ----");
    ...
    public void user_mainpage() {
        System.out.println("--------------------------------------------------------");
        System.out.println("----- Library ---> Welcome User " + LibraryManagement.userID + "! -----");
    ...
    public static void main(String args[]) {
        LibraryManagement system_run = new LibraryManagement();
        system_run.homepage();
    }
}
